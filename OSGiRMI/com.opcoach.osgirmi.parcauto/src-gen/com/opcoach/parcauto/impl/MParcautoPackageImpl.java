...
import com.opcoach.parcauto.MParcAuto;
import com.opcoach.parcauto.MParcautoFactory;
import com.opcoach.parcauto.MParcautoPackage;
import com.opcoach.parcauto.MVoiture;
...
public class MParcautoPackageImpl extends EPackageImpl implements MParcautoPackage {
	 ...
	 * @see com.opcoach.parcauto.MParcautoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EOperation getParcAuto__CalculerROI__MVoiture() {
		return parcAutoEClass.getEOperations().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(parcAutoEClass, PARC_AUTO___CALCULER_ROI__MVOITURE);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getParcAuto__CalculerROI__MVoiture(), ecorePackage.getEFloat(), "calculerROI", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getVoiture(), "v", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEException(op, theBasemodelPackage.getRemoteException());
